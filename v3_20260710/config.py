...
描述: 继承 v2 全部配置参数, 新增 IPSO-SA/DBO 算法超参
依赖: v2_20260525/config.py
"""
import sys
from pathlib import Path

# 导入 v2 config 全部符号 (使用文件路径加载避免模块名冲突)
import importlib.util
_v3_dir = Path(__file__).parent
_v2_cfg_path = _v3_dir.parent / "v2_20260525" / "config.py"
...
# ============================================================
# v3 路径配置 (覆盖 v2 的路径)  # noqa: F405 — 这些符号来自 v2 config
# ============================================================
V3_DIR = _v3_dir
