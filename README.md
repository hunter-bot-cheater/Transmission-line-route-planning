...
V3 在 V2 的 RF成本表面 + A\* 管线基础上，新增群体智能对比框架：
...
### V3 CNN 成本表面 (U-Net像素级回归, RTX4060 GPU)

| 指标 | A\* | IPSO-SA | DBO |
|------|-----|---------|-----|
| Hausdorff 均值 | 5,781m | **4,595m** | 6,039m |
| 重叠率均值 | 28.4% | **30.8%** | 28.5% |
| 质量门控通过 | 8/10 | **7/10** | 2/10 |
| vs RF 改善 | ↓7% | **↓21%** | ≈ |

统计检验: 配对t检验, n=10, Cohen's d=0.22 (小效应)
